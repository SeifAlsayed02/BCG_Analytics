...
def data_subplot(raw_data, movement, breathing, dc, t1, t2):
    print(f"Debug: Entering data_subplot with t1={t1}, t2={t2}, raw_data length={len(raw_data)}")
    ...
    if not os.path.exists(results_dir):
        ...
        print(f"Debug: Created results directory at {results_dir}")
    
    save_path = os.path.join(results_dir, 'vitals.png')
