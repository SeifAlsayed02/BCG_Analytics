...
# In general if the std is less than 15, it means that there is no any pressure applied to the mat.
...
def detect_patterns(pt1, pt2, win_size, data, time, plot):
    ...
    plt.savefig(os.path.join(output_dir, 'rawData.png'))
    plt.close()  # Added to free memory after saving
